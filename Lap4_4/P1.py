...
if __name__ == "__main__":
    ...
    print(f"lighting: {bedroom.get_recommended_lighting()} lumens per Square Foot")

    print("\n== Kitchen1 ==")
    kitchen1 = room.Kitchen(20, 25, has_island=True)
    print(kitchen1.describe_room())
    print(f"Purpose: {kitchen1.get_purpose()}")
    print(f"Recommended lighting: {kitchen1.get_recommended_lighting()} lumens per Square Foot")
    ...
    print(f"Purpose: {kitchen2.get_purpose()}")
    print(f"Recommended lighting: {kitchen2.get_recommended_lighting()} lumens per Square Foot")
