...
class MainWindow(QMainWindow):
    def __init__ (self):
        ...
        try:   
            ...
            image_part = os.path.join(current_dir, "g.png")
            ...
            instagram_image.setText("Image not found: g.png")
            instagram_image.setAlignment(Qt.AlignCenter)
        ...
        try:
            current_dir = os.path.dirname(os.path.abspath(__file__))
            image_part = os.path.join(current_dir, "f.png")
            ...
            facebook_image.setText("Image not found: f.png")
        ...
        try:
            in_image = QLabel()
            current_dir = os.path.dirname(os.path.abspath(__file__))
            image_part = os.path.join(current_dir, "in.png")
            ...
            in_image.setText("Image not found: in.png")
            in_image.setAlignment(Qt.AlignCenter)
